    ...
    const items = [
      [
        ...
        },
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('modelsContextMenu.unloadModel') || 'Unload'
            )
          },
          getEnabled: (context) => {
            return context.bimViewer.isModelLoaded(context.modelId)
    ...
    if (enableEditModels) {
      items.push([
        ...
        },
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('modelsContextMenu.deleteModel') || 'Delete'
            )
          },
          getEnabled: (context) => {
            return true
    ...
    items.push([
      {
        getTitle: (context) => {
          return (
            context.viewer.localeService.translate('modelsContextMenu.loadAllModels') || 'Load All'
          )
        },
        getEnabled: (context) => {
      ...
      },
      {
        getTitle: (context) => {
          return (
            context.viewer.localeService.translate('modelsContextMenu.unloadAllModels') ||
            'Unload All'
          )
        },
        getEnabled: (context) => {
    ...
    items.push([
      {
        getTitle: (context) => {
          return (
            context.viewer.localeService.translate('modelsContextMenu.clearSlices') ||
            'Clear Slices'
          )
        },
        getEnabled: (context) => {
            ...
            [
              {
                getTitle: (context) => {
                  return (
                    context.viewer.localeService.translate('canvasContextMenu.clearMeasurements') ||
                    'Clear'
                  )
                },
                getEnabled: (context) => {
