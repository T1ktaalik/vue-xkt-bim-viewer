  ...
  _buildMenu() {
    ...
    for (let i = 0, len = sectionPlanes.length; i < len; i++) {
      ...
      sectionPlanesMenuItems.push({
        getTitle: (context) => {
          return (
            `${context.viewer.localeService.translate('sectionToolContextMenu.slice') || 'Slice'} #` +
            (i + 1)
          )
        },
        ...
        items: [
          ...
          [
            // Group
            {
              getTitle: (context) => {
                return sectionPlane.active
                  ? context.viewer.localeService.translate('sectionToolContextMenu.deactivate') ||
                      'Disable'
                  : context.viewer.localeService.translate('sectionToolContextMenu.activate') ||
                      'Enable'
              },
              doAction: (context) => {
            ...
            },
            {
              getTitle: (context) => {
                return (
                  context.viewer.localeService.translate('sectionToolContextMenu.edit') || 'Edit'
                )
              },
              getEnabled() {
                return sectionPlane.active
            ...
            },
            {
              getTitle: (context) => {
                return (
                  context.viewer.localeService.translate('sectionToolContextMenu.flip') || 'Flip'
                )
              },
              getEnabled() {
                return sectionPlane.active
...

            {
              getTitle: (context) => {
                return (
                  context.viewer.localeService.translate('sectionToolContextMenu.delete') ||
                  'Delete'
                )
              },
              doAction: (context) => {
      ...
      [
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('sectionToolContextMenu.clearSlices') ||
              'Clear Slices'
            )
          },
          getEnabled: (context) => {
        ...
        },
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('sectionToolContextMenu.flipSlices') ||
              'Flip Slices'
            )
          },
          getEnabled: (context) => {
      ...
      [
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('sectionToolContextMenu.disableAllSlices') ||
              'Disable all Slices'
            )
          },
          getEnabled: (context) => {
        ...
        },
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('sectionToolContextMenu.enableAllSlices') ||
              'Enable all Slices'
            )
          },
          getEnabled: (context) => {
