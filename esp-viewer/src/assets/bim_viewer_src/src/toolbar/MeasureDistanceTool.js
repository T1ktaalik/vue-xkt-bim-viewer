...
export class MeasureDistanceTool extends Controller {
  constructor(parent, cfg) {
    ...
    this._contextMenu = new ContextMenu({
      items: [
        [
          {
            getTitle: (context) => {
              return context.measurement.axisVisible
                ? 'Hide Measurement Axis'
                : 'Show Measurement Axis'
            },
    ...
    this._distanceMeasurementsPlugin.on('mouseLeave', (e) => {
      if (
        this._contextMenu.shown &&
        this._contextMenu.context.measurement.id === e.measurement.id
      ) {
        return
      }
    ...
    this._distanceMeasurementsMouseControl = new DistanceMeasurementsMouseControl(
      this._distanceMeasurementsPlugin,
      {
