...
const messages = {
  ...
  ru: {
    ...
    modelsExplorer: {
      ...
      loadAllTip: 'Загрузить все модели в проект',
      unloadAll: 'Выгрузить все',
      unloadAllTip: 'Выгрузить все модели из проекта',
      add: 'Добавить',
    ...
    storeysExplorer: {
      ...
      title: 'Уровни',
      showAll: 'Показать всё',
      showAllTip: 'Показать все уровни',
      hideAll: 'Скрыть всё',
      hideAllTip: 'Скрыть все уровни'
    },
    propertiesInspector: {
      // The "Properties" tab on the right of the canvas
      title: 'Свойства'
    ...
    toolbar: {
      // The toolbar at the top of the canvas
      toggleExplorer: 'Скрыть/показать обозреватель', // Button to open or close the explorer panel on the left
      ...
      togglePerspectiveTip: 'Переключить перспектива/ортогональность', // Button to toggle between perspective and orthographic projection
      viewFitTip: 'Фокус на объект', // Button to position the camera to fit all objects in view
      firstPersonTip: 'Переключение на вид от первого лица', // Button to switch between first-person and orbit navigation modes
      ...
      queryObjectsTip: 'Поиск объектов', // Button to activate "Query objects" tool
      sliceObjectsTip: 'Разрез объектов', // Button to activate "Slice objects" tool
      slicesMenuTip: 'Меню разрезов', // Button to open the pull-down menu of existing section planes
      numSlicesTip: 'Количество разрезов' // Label shows number of sexisting section planes
    },
    canvasContextMenu: {
      // Context menu that appears when we right-click on empty canvas space
      viewFitAll: 'Фокус на весь объект', // Menu option to position the camera to fit all objects in view
      hideAll: 'Скрыть всё', // Menu option to hide all objects
      showAll: 'Показать всё', // Menu option to show all objects
      xRayAll: 'X-Ray для всего', // Menu option to X-ray all objects
      xRayNone: 'X-Ray сбросить', // Menu option to remove X-ray effect from all objects
      ...
      clearSlices: 'Удалить разрезы' // Menu option to delete all section planes created with the Slice tool
    },
    modelsContextMenu: {
      // Context menu that appears when we right-click on a model in the "Models" tab
      loadModel: 'Загрузить',
      ...
      clearSlices: 'Сбросить разрезы'
    },
    objectContextMenu: {
      // Context menu that appears when we right-click on an object in the 3D view
      viewFit: 'Фокус на объект', // Menu option to position the camera to fit the object in view
      viewFitAll: 'Фокус на всю модель', // Menu option to position the camera to fit all objects in view
      showInTree: 'Показать в обозревателе', // Menu option to show the object in the Objects tab's tree
      hide: 'Скрыть', // Menu option to hide this object
      hideOthers: 'Скрыть все прочие', // Menu option to hide other objects
      hideAll: 'Скрыть все', // Menu option to hide all objects
      showAll: 'Показать все', // Menu option to show all objects
      xray: 'X-Ray для объекта', // Menu option to X-ray this object
      xrayOthers: 'X-Ray для всех прочих', // Menu option to undo X-ray on all other objects
      xrayAll: 'X-Ray для всего', // Menu option to X-ray all objects
      xrayNone: 'X-Ray сбросить', // Menu option to remove X-ray effect from all objects
      select: 'Выбрать', // Menu option to select this object
      undoSelect: 'Отменить выбор', // Menu option to deselect this object
      selectNone: 'Сбросить выбор', // Menu option to deselect all objects
      clearSlices: 'Удалить разрезы' // Menu option to delete all slices made with the Slicing tool
    },
    treeViewContextMenu: {
      // Context menu that appears when we right-click an object node in the tree within in the "Objects" tab
      viewFit: 'Фокус на объект', // Menu option to position the camera to fit the object in view
      viewFitAll: 'Фокус на всю модель', // Menu option to position the camera to fit all objects in view
      isolate: 'Показать изолированно', // Menu option to hide all other objects and fit this object in view
      hide: 'Скрыть', // Menu option to hide this object
      hideOthers: 'Скрыть все прочие', // Menu option to hide other objects
      hideAll: 'Скрыть все', // Menu option to hide all objects
      show: 'Показать', // Menu option to show this object
      showOthers: 'Показать все прочие', // Menu option to hide this object and show all others
      showAll: 'Показать все', // Menu option to show all objects
      xray: 'X-Ray', // Menu option to X-ray this object
      ...
      xrayAll: 'X-Ray для всего', // Menu option to X-ray all objects
      xrayNone: 'X-Ray сбросить', // Menu option to remove X-ray effect from all objects
      select: 'Выбор', // Menu option to select this object
      undoSelect: 'Отменить выбор', // Menu option to deselect this object
      selectNone: 'Сбросить выбранные', // Menu option to deselect all objects
      clearSlices: 'Удалить разрезы' // Menu option to delete all slices made with the Slicing tool
    },
    sectionToolContextMenu: {
      // Context menu that appears when we right-click an the Slicing tool
      slice: 'Разрез', // Title of submenu for each slice, eg. "Slice #0, Slice #1" etc
      clearSlices: 'Удалить разрезы', // Menu option to delete all slices
      flipSlices: 'Перевернуть разрез', // Menu option to reverse the cutting direction of all slices
