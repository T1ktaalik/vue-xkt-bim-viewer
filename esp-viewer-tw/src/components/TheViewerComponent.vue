<template>
  <div class="tw-w-full tw-h-full">
    ...
    >
    <KeyboardDoubleArrowLeftFilled v-if="showExplorer" class="tw-text-blue-400 tw-w-[50px]" />
    <KeyboardDoubleArrowRightFilled v-else class=" tw-text-blue-400 tw-w-[50px]" />
    </button>
    <button
      id="inspectorSwitch"
      class="tw-z-40 tw-absolute tw-top-[50px]"
    ...
    >
    <KeyboardDoubleArrowRightFilled v-if="showInspector" class="tw-text-blue-400 tw-w-[50px]" />
    <KeyboardDoubleArrowLeftFilled v-else class=" tw-text-blue-400 tw-w-[50px]" />
    </button>
    <div
      id="viewerExplorer"
      class="tw-absolute tw-bg-blue-400/30 tw-w-[300px] tw-z-30 tw-h-screen tw-overflow-auto "
      ref="viewerExplorer"
      v-show="showExplorer"
    ></div>
    <div id="viewerInspector" v-show="showInspector" class="tw-absolute tw-right-0 tw-w-[350px] tw-h-screen tw-z-30 tw-bg-blue-400/30 tw-overflow-auto"></div>
...
import { KeyboardDoubleArrowLeftFilled, KeyboardDoubleArrowRightFilled, KeyboardDoubleArrowLeftRound } from '@vicons/material'
