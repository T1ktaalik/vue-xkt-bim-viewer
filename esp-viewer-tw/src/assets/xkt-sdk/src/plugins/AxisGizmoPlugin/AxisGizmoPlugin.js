...
class AxisGizmoPlugin extends Plugin {
  ...
  constructor(viewer, cfg) {
    ...
    const arrowHead = new ReadableGeometry(
      axisGizmoScene,
    ...
    const arrowShaft = new ReadableGeometry(
      axisGizmoScene,
      buildCylinderGeometry({
        radiusTop: 0.2,
        radiusBottom: 0.2,
    ...
    const xAxisMaterial = new PhongMaterial(axisGizmoScene, {
      // Red by convention
      diffuse: [1, 0.3, 0.3],
      ambient: [0.0, 0.0, 0.0],
    ...
    const xAxisLabelMaterial = new PhongMaterial(axisGizmoScene, {
      // Red by convention
      emissive: [1, 0.3, 0.3],
      ambient: [0.0, 0.0, 0.0],
      specular: [0.6, 0.6, 0.3],
    ...
    const yAxisMaterial = new PhongMaterial(axisGizmoScene, {
      // Green by convention
      diffuse: [0.3, 1, 0.3],
      ambient: [0.0, 0.0, 0.0],
      specular: [0.6, 0.6, 0.3],
    ...
    const yAxisLabelMaterial = new PhongMaterial(axisGizmoScene, {
      // Green by convention
      emissive: [0.3, 1, 0.3],
      ambient: [0.0, 0.0, 0.0],
      specular: [0.6, 0.6, 0.3],
    ...
    const zAxisMaterial = new PhongMaterial(axisGizmoScene, {
      // Blue by convention
      diffuse: [0.3, 0.3, 1],
      ambient: [0.0, 0.0, 0.0],
      specular: [0.6, 0.6, 0.3],
    ...
    this._meshes = [
      ...
      new Mesh(axisGizmoScene, {
        ...
        geometry: new ReadableGeometry(
          axisGizmoScene,
          buildVectorTextGeometry({ text: 'X', size: 1.5 })
        ),
      ...
      new Mesh(axisGizmoScene, {
        ...
        geometry: new ReadableGeometry(
          axisGizmoScene,
          buildVectorTextGeometry({ text: 'Y', size: 1.5 })
        ),
      ...
      new Mesh(axisGizmoScene, {
        ...
        geometry: new ReadableGeometry(
          axisGizmoScene,
          buildVectorTextGeometry({ text: 'Z', size: 1.5 })
        ),
