...
class Control {
  ...
  _createNodes() {
    ...
    const shapes = {
      ...
      arrowHead: new ReadableGeometry(
        rootNode,
      ...
      arrowHeadBig: new ReadableGeometry(
        rootNode,
        buildCylinderGeometry({
          radiusTop: 0.001,
          radiusBottom: 0.09,
      ...
      arrowHeadHandle: new ReadableGeometry(
        rootNode,
        buildCylinderGeometry({
          radiusTop: 0.09,
          radiusBottom: 0.09,
      ...
      curveHandle: new ReadableGeometry(
        rootNode,
        buildTorusGeometry({
          radius: hoopRadius,
      ...
      axisHandle: new ReadableGeometry(
        rootNode,
        buildCylinderGeometry({
          radiusTop: 0.08,
          radiusBottom: 0.08,
    ...
    const materials = {
      ...
      highlightRed: new EmphasisMaterial(rootNode, {
      ...
      highlightGreen: new EmphasisMaterial(rootNode, {
        // Emphasis for green rotation affordance hoop
        edges: false,
        fill: true,
        fillColor: [0, 1, 0],
        fillAlpha: 0.6
      ...
      highlightBlue: new EmphasisMaterial(rootNode, {
        // Emphasis for blue rotation affordance hoop
        edges: false,
        fill: true,
        fillColor: [0, 0, 1],
        fillAlpha: 0.2
    ...
    this._displayMeshes = {
      ...
      xCurveArrow1: rootNode.addChild(
        new Mesh(rootNode, {
          ...
          matrix: (function () {
            ...
            return math.mulMat4(
              math.mulMat4(translate, scale, math.identityMat4()),
              rotate,
              math.identityMat4()
            )
          })(),
      ...
      xCurveArrow2: rootNode.addChild(
        new Mesh(rootNode, {
          geometry: shapes.arrowHead,
          material: materials.red,
          matrix: (function () {
      ...
      yCurveHandle: rootNode.addChild(
        new Mesh(rootNode, {
          geometry: shapes.curveHandle,
          material: materials.pickable,
          rotation: [-90, 0, 0],
      ...
      yCurveArrow1: rootNode.addChild(
        new Mesh(rootNode, {
          geometry: shapes.arrowHead,
          material: materials.green,
          matrix: (function () {
      ...
      yCurveArrow2: rootNode.addChild(
        new Mesh(rootNode, {
          geometry: shapes.arrowHead,
          material: materials.green,
          matrix: (function () {
      ...
      zCurveHandle: rootNode.addChild(
        new Mesh(rootNode, {
          geometry: shapes.curveHandle,
          material: materials.pickable,
          matrix: math.rotationMat4v(180 * math.DEGTORAD, [1, 0, 0], math.identityMat4()),
      ...
      zCurveCurveArrow1: rootNode.addChild(
        new Mesh(rootNode, {
          geometry: shapes.arrowHead,
          material: materials.blue,
          matrix: (function () {
            const translate = math.translateMat4c(0.8, -0.07, 0, math.identityMat4())
            const scale = math.scaleMat4v([0.6, 0.6, 0.6], math.identityMat4())
      ...
      zCurveArrow2: rootNode.addChild(
        new Mesh(rootNode, {
          geometry: shapes.arrowHead,
          material: materials.blue,
          matrix: (function () {
            const translate = math.translateMat4c(0.05, -0.8, 0, math.identityMat4())
            const scale = math.scaleMat4v([0.6, 0.6, 0.6], math.identityMat4())
            const rotate = math.rotationMat4v(90 * math.DEGTORAD, [0, 0, 1], math.identityMat4())
            return math.mulMat4(
              math.mulMat4(translate, scale, math.identityMat4()),
      ...
      xAxisArrow: rootNode.addChild(
        new Mesh(rootNode, {
          ...
          material: materials.red,
          matrix: (function () {
            const translate = math.translateMat4c(0, radius + 0.1, 0, math.identityMat4())
            const rotate = math.rotationMat4v(-90 * math.DEGTORAD, [0, 0, 1], math.identityMat4())
      ...
      xAxisArrowHandle: rootNode.addChild(
        new Mesh(rootNode, {
      ...
      yAxisArrowHandle: rootNode.addChild(
        new Mesh(rootNode, {
          geometry: shapes.arrowHeadHandle,
          material: materials.pickable,
          matrix: (function () {
      ...
      zAxisArrowHandle: rootNode.addChild(
        new Mesh(rootNode, {
          geometry: shapes.arrowHeadHandle,
          material: materials.pickable,
          matrix: (function () {
  ...
  _bindEvents() {
    ...
    var dragRotateSectionPlane = (function () {
      ...
      return function (baseAxis, fromMouse, toMouse) {
        localToWorldVec(baseAxis, worldAxis)
        const hasData =
          getPointerPlaneIntersect(fromMouse, worldAxis, p1) &&
          getPointerPlaneIntersect(toMouse, worldAxis, p2)
        if (!hasData) {
...

    {
      ...
      canvas.addEventListener(
        'mousemove',
        (this._canvasMouseMoveListener = (e) => {
          if (!this._visible) {
            return
          }
          if (!down) {
