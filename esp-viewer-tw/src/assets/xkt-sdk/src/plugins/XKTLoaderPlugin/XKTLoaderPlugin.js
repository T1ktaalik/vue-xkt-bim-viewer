...
class XKTLoaderPlugin extends Plugin {
  ...
  load(params = {}) {
    ...
    options.reuseGeometries =
      params.reuseGeometries !== null && params.reuseGeometries !== undefined
        ? params.reuseGeometries
        : this._reuseGeometries !== false
    ...
    options.excludeUnclassifiedObjects =
      params.excludeUnclassifiedObjects !== undefined
        ? !!params.excludeUnclassifiedObjects
        : this._excludeUnclassifiedObjects
    options.globalizeObjectIds =
      params.globalizeObjectIds !== undefined && params.globalizeObjectIds !== null
        ? !!params.globalizeObjectIds
        : this._globalizeObjectIds
  ...
  _parseModel(arrayBuffer, params, options, sceneModel, metaModel, manifestCtx) {
    ...
    if (!parser) {
      this.error(
        'Unsupported .XKT file version: ' +
          xktVersion +
          ' - this XKTLoaderPlugin supports versions ' +
          Object.keys(parsers)
      )
      return
    }
