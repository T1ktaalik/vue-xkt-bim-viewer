    ...
    this._onCameraControlHoverSnapOrSurface = cameraControl.on(
      ...
      (event) => {
        ...
        if (this._currentDistanceMeasurement) {
          this._currentDistanceMeasurement.wireVisible =
            this._currentDistanceMeasurementInitState.wireVisible
          this._currentDistanceMeasurement.axisVisible =
            this._currentDistanceMeasurementInitState.axisVisible &&
            this.distanceMeasurementsPlugin.defaultAxisVisible
          this._currentDistanceMeasurement.xAxisVisible =
            this._currentDistanceMeasurementInitState.xAxisVisible &&
            this.distanceMeasurementsPlugin.defaultXAxisVisible
          this._currentDistanceMeasurement.yAxisVisible =
            this._currentDistanceMeasurementInitState.yAxisVisible &&
            this.distanceMeasurementsPlugin.defaultYAxisVisible
          this._currentDistanceMeasurement.zAxisVisible =
            this._currentDistanceMeasurementInitState.zAxisVisible &&
            this.distanceMeasurementsPlugin.defaultZAxisVisible
          this._currentDistanceMeasurement.targetVisible =
            this._currentDistanceMeasurementInitState.targetVisible
      ...
      (this._onMouseUp = (e) => {
        ...
        if (this._currentDistanceMeasurement) {
          if (mouseHovering) {
            ...
            this.distanceMeasurementsPlugin.fire(
              'measurementCancel',
              this._currentDistanceMeasurement
            )
            this._currentDistanceMeasurement = null
            hoveredEntity = null
          }
