...
class VBOInstancingLinesLayer {
  ...
  finalize() {
    ...
    if (colorsLength > 0) {
      ...
      this._state.colorsBuf = new ArrayBuf(
        gl,
        gl.ARRAY_BUFFER,
    ...
    if (flagsLength > 0) {
      ...
      let notNormalized = false
      this._state.flagsBuf = new ArrayBuf(
        gl,
        gl.ARRAY_BUFFER,
    ...
    if (this.model.scene.entityOffsetsEnabled) {
      if (this._offsets.length > 0) {
        ...
        this._state.offsetsBuf = new ArrayBuf(
          gl,
          gl.ARRAY_BUFFER,
    ...
    if (this._modelMatrixCol0.length > 0) {
      const normalized = false
      this._state.modelMatrixCol0Buf = new ArrayBuf(
        gl,
        gl.ARRAY_BUFFER,
      ...
      this._state.modelMatrixCol1Buf = new ArrayBuf(
        gl,
        gl.ARRAY_BUFFER,
      ...
      this._state.modelMatrixCol2Buf = new ArrayBuf(
        gl,
        gl.ARRAY_BUFFER,
