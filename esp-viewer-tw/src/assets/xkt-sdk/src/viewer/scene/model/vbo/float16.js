...
const {
  ...
  a = Proxy,
  y = Number,
  { isFinite: p, isNaN: w } = y,
  { iterator: g, species: d, toStringTag: v, for: b } = Symbol,
  A = Object,
  { create: m, defineProperty: B, freeze: x, is: E } = A,
  T = A.prototype,
  O = t(T.isPrototypeOf),
...
for (let t = 0; t < 256; ++t) {
  const r = t - 127
  r < -27
    ? ((Ft[t] = 0), (Ft[256 | t] = 32768), (Lt[t] = 24), (Lt[256 | t] = 24))
    : r < -14
      ? ((Ft[t] = 1024 >> (-r - 14)),
        (Ft[256 | t] = (1024 >> (-r - 14)) | 32768),
        (Lt[t] = -r - 1),
        (Lt[256 | t] = -r - 1))
      : r <= 15
        ? ((Ft[t] = (r + 15) << 10),
          (Ft[256 | t] = ((r + 15) << 10) | 32768),
          (Lt[t] = 13),
          (Lt[256 | t] = 13))
        : r < 128
          ? ((Ft[t] = 31744), (Ft[256 | t] = 64512), (Lt[t] = 24), (Lt[256 | t] = 24))
          : ((Ft[t] = 31744), (Ft[256 | t] = 64512), (Lt[t] = 13), (Lt[256 | t] = 13))
}
...
const lr = x({
  ...
  defineProperty: (t, r, n) =>
    Jt(r) && j(t, r) && j(n, 'value') ? ((n.value = Rt(n.value)), o(t, r, n)) : o(t, r, n)
})
class ar {
  constructor(t, r, n) {
    let o
  ...
  static from(t, ...r) {
    ...
    if (null != s)
      Ht(t)
        ? ((o = t), (i = t.length))
        : !Kt((c = t)) || (c[g] !== K && 'Array Iterator' !== c[g]()[v])
          ? ((o = [...t]), (i = o.length))
          : ((o = t), (i = it(t)))
    else {
    ...
    var c
    const f = new e(i)
    if (0 === r.length) for (let t = 0; t < i; ++t) f[t] = o[t]
    else {
      const t = r[0],
        e = r[1]
  ...
  every(t, ...r) {
    ...
    const e = ur(this),
      o = it(e),
      i = r[0]
    for (let r = 0; r < o; ++r) if (!n(t, i, [Mt(e[r]), r, this])) return !1
    return !0
  }
  some(t, ...r) {
    sr(this)
    const e = ur(this),
      o = it(e),
      i = r[0]
    for (let r = 0; r < o; ++r) if (n(t, i, [Mt(e[r]), r, this])) return !0
    return !1
  }
  set(t, ...r) {
    sr(this)
  ...
  slice(...t) {
    ...
    let s, c
    ;(s = o === -1 / 0 ? 0 : o < 0 ? (e + o > 0 ? e + o : 0) : e < o ? e : o),
      (c = i === -1 / 0 ? 0 : i < 0 ? (e + i > 0 ? e + i : 0) : e < i ? e : i)
    const u = c - s > 0 ? c - s : 0,
      f = new n(u)
  ...
  indexOf(t, ...r) {
    ...
    if (o === 1 / 0) return -1
    o < 0 && ((o += e), o < 0 && (o = 0))
    for (let r = o; r < e; ++r) if (j(n, r) && Mt(n[r]) === t) return r
    return -1
  }
  lastIndexOf(t, ...r) {
    sr(this)
    ...
    for (let r = o; r >= 0; --r) if (j(n, r) && Mt(n[r]) === t) return r
    return -1
  }
  includes(t, ...r) {
    sr(this)
