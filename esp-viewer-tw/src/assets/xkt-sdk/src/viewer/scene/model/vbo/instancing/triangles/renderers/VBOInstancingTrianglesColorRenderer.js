...
class VBOInstancingTrianglesColorRenderer extends VBOSceneModelTriangleInstancingRenderer {
  ...
  _buildVertexShader() {
    ...
    src.push(
      'vec4 worldNormal = worldNormalMatrix * vec4(dot(modelNormal, modelNormalMatrixCol0), dot(modelNormal, modelNormalMatrixCol1), dot(modelNormal, modelNormalMatrixCol2), 0.0);'
    )
