...
class VBOInstancingTrianglesRenderers {
  ...
  eagerCreateRenders() {
    ...
    if (!this._silhouetteRenderer) {
      // Used for highlighting and selection
  ...
  get flatColorRendererWithSAO() {
    if (!this._flatColorRendererWithSAO) {
      this._flatColorRendererWithSAO = new VBOInstancingTrianglesFlatColorRenderer(
        this._scene,
        true
      )
    }
  ...
  get colorTextureRenderer() {
    if (!this._colorTextureRenderer) {
      this._colorTextureRenderer = new VBOInstancingTrianglesColorTextureRenderer(
        this._scene,
        false
      )
    }
  ...
  get colorTextureRendererWithSAO() {
    if (!this._colorTextureRendererWithSAO) {
      this._colorTextureRendererWithSAO = new VBOInstancingTrianglesColorTextureRenderer(
        this._scene,
        true
      )
    }
