...
class Texture extends Component {
  ...
  constructor(owner, cfg = {}) {
    ...
    this._state = new RenderState({
      ...
      hasMatrix:
        (cfg.translate && (cfg.translate[0] !== 0 || cfg.translate[1] !== 0)) ||
        !!cfg.rotate ||
        (cfg.scale && (cfg.scale[0] !== 0 || cfg.scale[1] !== 0)),
  ...
  _checkMinFilter(value) {
    ...
    if (
      ...
      this.error(
        "Unsupported value for 'minFilter' - supported values are LinearFilter, LinearMipMapNearestFilter, NearestMipMapNearestFilter, " +
  ...
  _checkMagFilter(value) {
    ...
    if (value !== LinearFilter && value !== NearestFilter) {
      this.error(
        "Unsupported value for 'magFilter' - supported values are LinearFilter and NearestFilter. Defaulting to LinearFilter."
      )
      value = LinearFilter
    }
    return value
  ...
  _checkWrapS(value) {
    ...
    if (
      ...
      this.error(
        "Unsupported value for 'wrapS' - supported values are ClampToEdgeWrapping, MirroredRepeatWrapping and RepeatWrapping. Defaulting to RepeatWrapping."
      )
      value = RepeatWrapping
    }
    return value
  ...
  _checkWrapT(value) {
    ...
    if (
      ...
      this.error(
        "Unsupported value for 'wrapT' - supported values are ClampToEdgeWrapping, MirroredRepeatWrapping and RepeatWrapping. Defaulting to RepeatWrapping."
      )
      value = RepeatWrapping
    }
    return value
  ...
  _checkEncoding(value) {
    ...
    if (value !== LinearEncoding && value !== sRGBEncoding) {
      this.error(
        "Unsupported value for 'encoding' - supported values are LinearEncoding and sRGBEncoding. Defaulting to LinearEncoding."
      )
  ...
  _update() {
    ...
    if (this._matrixDirty) {
      ...
      if (this._translate[0] !== 0 || this._translate[1] !== 0) {
        matrix = math.translationMat4v(
          [this._translate[0], this._translate[1], 0],
          this._state.matrix
        )
      }
