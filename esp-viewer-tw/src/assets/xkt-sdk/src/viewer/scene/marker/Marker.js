...
class Marker extends Component {
  ...
  _update() {
    // this._needUpdate() schedules this for next tick
  ...
  _setVisible(visible) {
    // Called by VisibilityTester and this._entity.on("destroyed"..)
  ...
  set entity(entity) {
    ...
    if (this._entity) {
      if (this._entity instanceof SceneModelEntity) {
        this._onEntityModelDestroyed = this._entity.model.on('destroyed', () => {
          // SceneModelEntity does not fire events, and cannot exist beyond its VBOSceneModel
