...
class CameraControl extends Component {
  ...
  constructor(owner, cfg = {}) {
    ...
    this._handlers = [
      ...
      new TouchPanRotateAndDollyHandler(
        this.scene,
        this._controllers,
        this._configs,
        this._states,
      ...
      new MousePanRotateDollyHandler(
        this.scene,
        this._controllers,
        this._configs,
        this._states,
      ...
      new KeyboardPanRotateDollyHandler(
        this.scene,
        this._controllers,
        this._configs,
        this._states,
    ...
    this._cameraUpdater = new CameraUpdater(
      this.scene,
      this._controllers,
      this._configs,
      this._states,
  ...
  set navMode(navMode) {
    ...
    if (navMode !== 'firstPerson' && navMode !== 'orbit' && navMode !== 'planView') {
      this.error(
        'Unsupported value for navMode: ' +
          navMode +
          " - supported values are 'orbit', 'firstPerson' and 'planView' - defaulting to 'orbit'"
      )
      navMode = 'orbit'
    }
  ...
  set rotationInertia(rotationInertia) {
    this._configs.rotationInertia =
      rotationInertia !== undefined && rotationInertia !== null ? rotationInertia : 0.0
  }
  ...
  set keyboardPanRate(keyboardPanRate) {
    this._configs.keyboardPanRate =
      keyboardPanRate !== null && keyboardPanRate !== undefined ? keyboardPanRate : 5.0
  }
  ...
  set touchPanRate(touchPanRate) {
    this._configs.touchPanRate =
      touchPanRate !== null && touchPanRate !== undefined ? touchPanRate : 1.0
  }
  ...
  set keyboardRotationRate(keyboardRotationRate) {
    this._configs.keyboardRotationRate =
      keyboardRotationRate !== null && keyboardRotationRate !== undefined
        ? keyboardRotationRate
        : 90.0
  }
  ...
  set dragRotationRate(dragRotationRate) {
    this._configs.dragRotationRate =
      dragRotationRate !== null && dragRotationRate !== undefined ? dragRotationRate : 360.0
  }
  ...
  set keyboardDollyRate(keyboardDollyRate) {
    this._configs.keyboardDollyRate =
      keyboardDollyRate !== null && keyboardDollyRate !== undefined ? keyboardDollyRate : 15.0
  }
  ...
  set touchDollyRate(touchDollyRate) {
    this._configs.touchDollyRate =
      touchDollyRate !== null && touchDollyRate !== undefined ? touchDollyRate : 0.2
  }
  ...
  set mouseWheelDollyRate(mouseWheelDollyRate) {
    this._configs.mouseWheelDollyRate =
      mouseWheelDollyRate !== null && mouseWheelDollyRate !== undefined
        ? mouseWheelDollyRate
        : 100.0
  }
  ...
  set dollyInertia(dollyInertia) {
    this._configs.dollyInertia =
      dollyInertia !== undefined && dollyInertia !== null ? dollyInertia : 0
  }
  ...
  set dollyProximityThreshold(dollyProximityThreshold) {
    this._configs.dollyProximityThreshold =
      dollyProximityThreshold !== undefined && dollyProximityThreshold !== null
        ? dollyProximityThreshold
        : 35.0
  }
  ...
  set dollyMinSpeed(dollyMinSpeed) {
    this._configs.dollyMinSpeed =
      dollyMinSpeed !== undefined && dollyMinSpeed !== null ? dollyMinSpeed : 0.04
  }
