...
DrawRenderer.prototype.drawMesh = function (frameCtx, mesh) {
  ...
  gl.uniformMatrix4fv(
    this._uViewMatrix,
    false,
    origin ? frameCtx.getRTCViewMatrix(meshState.originHash, origin) : camera.viewMatrix
  )
    ...
    switch (materialState.type) {
      ...
      case 'PhongMaterial':
        ...
        if (
          ...
          material._ambientMap._state.texture &&
          this._uMaterialAmbientMap
        ) {
          program.bindTexture(
            this._uMaterialAmbientMap,
            material._ambientMap._state.texture,
          ...
          if (this._uMaterialAmbientMapMatrix) {
            gl.uniformMatrix4fv(
              this._uMaterialAmbientMapMatrix,
              false,
              material._ambientMap._state.matrix
            )
          }
        }
        if (material._diffuseMap && material._diffuseMap._state.texture && this._uDiffuseMap) {
          program.bindTexture(
            this._uDiffuseMap,
            material._diffuseMap._state.texture,
            frameCtx.textureUnit
          )
          frameCtx.textureUnit = (frameCtx.textureUnit + 1) % maxTextureUnits
          frameCtx.bindTexture++
        ...
        if (material._specularMap && material._specularMap._state.texture && this._uSpecularMap) {
          program.bindTexture(
            this._uSpecularMap,
            material._specularMap._state.texture,
            frameCtx.textureUnit
          )
          frameCtx.textureUnit = (frameCtx.textureUnit + 1) % maxTextureUnits
          frameCtx.bindTexture++
          if (this._uSpecularMapMatrix) {
            gl.uniformMatrix4fv(
              this._uSpecularMapMatrix,
              false,
              material._specularMap._state.matrix
            )
          }
        }
        if (material._emissiveMap && material._emissiveMap._state.texture && this._uEmissiveMap) {
          program.bindTexture(
            this._uEmissiveMap,
            material._emissiveMap._state.texture,
            frameCtx.textureUnit
          )
          frameCtx.textureUnit = (frameCtx.textureUnit + 1) % maxTextureUnits
          frameCtx.bindTexture++
          if (this._uEmissiveMapMatrix) {
            gl.uniformMatrix4fv(
              this._uEmissiveMapMatrix,
              false,
              material._emissiveMap._state.matrix
            )
          }
        }
        if (material._alphaMap && material._alphaMap._state.texture && this._uAlphaMap) {
          program.bindTexture(
            this._uAlphaMap,
            material._alphaMap._state.texture,
            frameCtx.textureUnit
          )
          frameCtx.textureUnit = (frameCtx.textureUnit + 1) % maxTextureUnits
          frameCtx.bindTexture++
        ...
        if (
          ...
          material._reflectivityMap._state.texture &&
          this._uReflectivityMap
        ) {
          program.bindTexture(
            this._uReflectivityMap,
            material._reflectivityMap._state.texture,
          ...
          if (this._uReflectivityMapMatrix) {
            gl.uniformMatrix4fv(
              this._uReflectivityMapMatrix,
              false,
              material._reflectivityMap._state.matrix
            )
          }
        }
        if (material._normalMap && material._normalMap._state.texture && this._uNormalMap) {
          program.bindTexture(
            this._uNormalMap,
            material._normalMap._state.texture,
            frameCtx.textureUnit
          )
          frameCtx.textureUnit = (frameCtx.textureUnit + 1) % maxTextureUnits
          frameCtx.bindTexture++
        ...
        if (
          ...
          material._occlusionMap._state.texture &&
          this._uOcclusionMap
        ) {
          program.bindTexture(
            this._uOcclusionMap,
          ...
          if (this._uOcclusionMapMatrix) {
            gl.uniformMatrix4fv(
              this._uOcclusionMapMatrix,
              false,
              material._occlusionMap._state.matrix
            )
          }
        }
        ...
        if (material._reflectivityFresnel) {
          ...
          if (this._uReflectivityFresnelCenterBias) {
            gl.uniform1f(
              this._uReflectivityFresnelCenterBias,
              material._reflectivityFresnel.centerBias
            )
          }
          if (this._uReflectivityFresnelEdgeColor) {
            gl.uniform3fv(
              this._uReflectivityFresnelEdgeColor,
              material._reflectivityFresnel.edgeColor
            )
          }
          if (this._uReflectivityFresnelCenterColor) {
            gl.uniform3fv(
              this._uReflectivityFresnelCenterColor,
              material._reflectivityFresnel.centerColor
            )
          }
      ...
      case 'MetallicMaterial':
        ...
        if (
          ...
          metallicRoughnessMap._state.texture &&
          this._uMetallicRoughnessMap
        ) {
          program.bindTexture(
            this._uMetallicRoughnessMap,
            metallicRoughnessMap._state.texture,
          ...
          if (this._uMetallicRoughnessMapMatrix) {
            gl.uniformMatrix4fv(
              this._uMetallicRoughnessMapMatrix,
              false,
              metallicRoughnessMap._state.matrix
            )
          }
        }
      ...
      case 'SpecularMaterial':
        ...
        if (glossinessMap && glossinessMap._state.texture && this._uGlossinessMap) {
          program.bindTexture(
            this._uGlossinessMap,
            glossinessMap._state.texture,
            frameCtx.textureUnit
          )
          frameCtx.textureUnit = (frameCtx.textureUnit + 1) % maxTextureUnits
          frameCtx.bindTexture++
        ...
        if (
          ...
          specularGlossinessMap._state.texture &&
          this._uSpecularGlossinessMap
        ) {
          program.bindTexture(
            this._uSpecularGlossinessMap,
            specularGlossinessMap._state.texture,
          ...
          if (this._uSpecularGlossinessMapMatrix) {
            gl.uniformMatrix4fv(
              this._uSpecularGlossinessMapMatrix,
              false,
              specularGlossinessMap._state.matrix
            )
          }
        }
        var emissiveMap = material._emissiveMap
  ...
  if (geometryState.indicesBuf) {
    gl.drawElements(
      geometryState.primitive,
      geometryState.indicesBuf.numItems,
      geometryState.indicesBuf.itemType,
      0
    )
  ...
  switch (materialState.type) {
    ...
    case 'PhongMaterial':
      ...
      if (material._reflectivityFresnel) {
        ...
        this._uReflectivityFresnelCenterColor = program.getLocation(
          'reflectivityFresnelCenterColor'
        )
    ...
    case 'SpecularMaterial':
      ...
      if (material._specularGlossinessMap) {
        ...
        this._uSpecularGlossinessMapMatrix = program.getLocation(
          'materialSpecularGlossinessMapMatrix'
        )
      }
      if (material._emissiveMap) {
        this._uEmissiveMap = 'emissiveMap'
...
DrawRenderer.prototype._bindProgram = function (frameCtx) {
  ...
  if (
    ...
    lightsState.reflectionMaps[0].texture &&
    this._uReflectionMap
  ) {
    program.bindTexture(
      this._uReflectionMap,
      lightsState.reflectionMaps[0].texture,
