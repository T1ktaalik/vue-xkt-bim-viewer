  ...
  constructor(server, cfg = {}) {
    ...
    this.viewer.scene.on('rendered', () => {
      ...
      fastNavPlugin.hideEdges =
        hideEdgesMinDrawCount < stats.frame.drawElements + stats.frame.drawArrays
      fastNavPlugin.scaleCanvasResolution =
        scaleCanvasResolutionMinDrawCount < stats.frame.drawElements + stats.frame.drawArrays
    })
