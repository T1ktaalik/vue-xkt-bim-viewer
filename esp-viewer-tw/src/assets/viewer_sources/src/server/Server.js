...
class Server {
  ...
  getObjModel(projectId, modelId, done, error) {
    const url =
      this._dataDir + '/projects/' + projectId + '/models/' + modelId + '/' + projectId + '.obj'
    done(url)
  }
  ...
  getGltfModel(projectId, modelId, done, error) {
    const url =
      this._dataDir + '/projects/' + projectId + '/models/' + modelId + '/' + projectId + '.gltf'
    done(url)
  }
  /**
   * Gets obj for a model within a project.
   ...
   * @param {Function} error Callback through which an error message is returned on error.
   */
  getGlbModel(projectId, modelId, done, error) {
    const url =
      this._dataDir + '/projects/' + projectId + '/models/' + modelId + '/' + projectId + '.glb'
    done(url)
  }
}
