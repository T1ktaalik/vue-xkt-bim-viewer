  ...
  _buildMenu() {
    ...
    if (this._bimViewer._enablePropertiesInspector) {
      showObjectItems.push({
        getTitle: (context) => {
          return (
            context.viewer.localeService.translate('treeViewContextMenu.inspectProperties') ||
            'Inspect Properties'
          )
        },
        getShown(context) {
      ...
      ...[
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('treeViewContextMenu.viewFit') || 'View Fit'
            )
          },
        ...
        },
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('treeViewContextMenu.viewFitAll') ||
              'View Fit All'
            )
          },
          doAction: function (context) {
    ...
    this.items = [
      ...
      [
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('treeViewContextMenu.isolate') || 'Isolate'
            )
          },
          doAction: function (context) {
            const viewer = context.viewer
      ...
      [
        ...
        },
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('treeViewContextMenu.hideOthers') ||
              'Hide Others'
            )
          },
          doAction: function (context) {
        ...
        },
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('treeViewContextMenu.hideAll') || 'Hide All'
            )
          },
      ...
      [
        ...
        },
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('treeViewContextMenu.showOthers') ||
              'Shows Others'
            )
          },
          doAction: function (context) {
        ...
        },
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('treeViewContextMenu.showAll') || 'Show All'
            )
          },
          getEnabled: function (context) {
            const scene = context.viewer.scene
      ...
      [
        ...
        },
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('treeViewContextMenu.undoXray') || 'Undo X-Ray'
            )
          },
          doAction: function (context) {
            context.treeViewPlugin.withNodeTree(context.treeViewNode, (treeViewNode) => {
        ...
        },
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('treeViewContextMenu.xrayOthers') ||
              'X-Ray Others'
            )
          },
          doAction: function (context) {
        ...
        },
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('treeViewContextMenu.xrayAll') || 'X-Ray All'
            )
          },
          doAction: function (context) {
            const scene = context.viewer.scene
        ...
        },
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('treeViewContextMenu.xrayNone') || 'X-Ray None'
            )
          },
          getEnabled: function (context) {
      ...
      [
        ...
        },
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('treeViewContextMenu.undoSelect') ||
              'Undo Select'
            )
          },
          doAction: function (context) {
        ...
        },
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('treeViewContextMenu.selectNone') ||
              'Select None'
            )
          },
          getEnabled: function (context) {
      ...
      [
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('treeViewContextMenu.clearSlices') ||
              'Clear Slices'
            )
          },
          getEnabled: function (context) {
