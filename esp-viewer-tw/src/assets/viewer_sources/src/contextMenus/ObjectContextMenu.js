    ...
    this.items = [
      ...
      [
        ...
        },
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('objectContextMenu.xrayAll') || 'X-Ray All'
            )
          },
          getEnabled: (context) => {
            const scene = context.viewer.scene
        ...
        },
        {
          getTitle: (context) => {
            return (
              context.viewer.localeService.translate('objectContextMenu.xrayNone') || 'X-Ray None'
            )
          },
          getEnabled: (context) => {
